    ...
    <div class="container">
        ...
        <form action="<?php echo e(route('compras.update', $compra->id)); ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" name="precio" class="form-control" id="precio" value="<?php echo e($compra->precio); ?>" required>
            </div>
            <div class="form-group">
                <label for="fecha_compra">Fecha de Compra</label>
                <input type="date" name="fecha_compra" class="form-control" id="fecha_compra" value="<?php echo e($compra->fecha_compra); ?>" required>
            </div>
            <div class="form-group">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jp23\Downloads\poso\resources\views\compras\edit.blade.php ENDPATH**/ ?>