...
<div class="container">
    ...
    <form action="<?php echo e(route('inventarios.update', $inventario->id)); ?>" method="POST">
        ...
        <div>
            ...
            <input type="date" name="fecha_entrada" value="<?php echo e($inventario->fecha_entrada); ?>" class="form-control">
        </div>
        <div>
            <label>Fecha Salida:</label>
            <input type="date" name="fecha_salida" value="<?php echo e($inventario->fecha_salida); ?>" class="form-control">
        </div>
        <div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jp23\Downloads\poso\resources\views/inventarios/edit.blade.php ENDPATH**/ ?>